/*module functional_cov(
  ...
  covergroup cg_priority @(posedge tbCover.clk);
    cp_req: coverpoint tbCover.req{
      bins req_0 = {1};
    }
    cp_accmodule: coverpoint tbCover.accmodule{
  ...
  covergroup cg_m1_high_priority @(posedge tbCover.clk);
    ...
    /*cp_no_m3_interrupt_m1: coverpoint tbCover.mstate {
  ...
  covergroup cg_m1_indef_access @(posedge tbCover.clk);
    ...
    /*cp_m1_free_no_interrupt: coverpoint tbCover.mstate {
